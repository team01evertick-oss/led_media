...
<div class="project-card">
    ...
    <div class="project-image">
        ...
        <img
            src="{{ asset('storage/image/project1.png') }}"
            alt="Ministry of Land Management Display"
...
<div class="project-card reverse">
    ...
    <div class="project-image">
        ...
        <img
            src="{{ asset('storage/image/project2.png') }}"
            alt="Phnom Penh Gendarmerie Display"
            class="project-card__image"
        >
...
<div class="project-card">
    ...
    <div class="project-image">
        ...
        <img
            src="{{ asset('storage/image/project3.png') }}"
            alt="ASEAN Summit 2022"
            class="project-card__image"
        >
